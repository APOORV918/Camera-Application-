...
vidRecordBtn.addEventListener("click",function() {
    if(!recordState) {
        ...
        vidRecordBtn.innerHTML = `<img src="https://img.icons8.com/flat-round/64/000000/stop.png"/>`;
    } else {
        mediaRecorder.stop();
        recordState = false;
        ...
        vidRecordBtn.innerHTML = `<img src="https://img.icons8.com/flat-round/64/000000/record.png"/>`;
    }
});
...
function capture() {
    ...
    if(filter != "") {
        ...
        // ctx.drawImage(videoPlayer, canvas.width, canvas.height);
    }
...
showGallery.addEventListener("click", function(e){
    ...
    modal.innerHTML = `<div class="tittle">
                           <span class="tittle-child">GALLERY</span>
                           <span class="material-icons icon close-icon" style="float:right; margin-top: 10px; margin-right: 20px;">cancel</span>
                       </div>
                       <div class="gallery">
